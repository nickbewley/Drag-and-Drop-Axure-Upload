...
function readURL2(input) {
	if (input.files && input.files[0]) {
		...
		reader.onload = function (e) {
			...
			var myNewImageElement = $("<a href='" + e.target.result + "' style='width: 55px; display:inline-block; position:static; margin-right: 4px;' data-lightbox='createassetlb' data-label='Carousel Image'><img style='float:left;  height: 100%; position: relative; width: 55px; margin-right: 4px;' src='" + e.target.result + "' /></a>'");
